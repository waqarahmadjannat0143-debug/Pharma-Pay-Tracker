...
export default function Aging(){
 ...
 const {data,isLoading}=useQuery({queryKey:["aging-report"],queryFn:async()=>{const t=await getAuthToken();const r=await fetch(`${getBaseUrl()}/api/reports/aging`,{headers:{Authorization:`Bearer ${t}`}});if(!r.ok)throw new Error("Failed");return r.json();}});
