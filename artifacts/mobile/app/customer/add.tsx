  ...
  const handleSave = async () => {
    ...
    try {
      if (
        ...
        Alert.alert(
          "Validation",
          "Serial number positive whole number hona chahiye",
        );
        return;
      }
      await mutateAsync({
        data: {
          ...
          registerNumber: registerNumber ? Number(registerNumber) : undefined,
        },
      });
      ...
      Alert.alert(
        "Error",
        error?.message || "Failed to add store. Please try again.",
      );
    }
  };
