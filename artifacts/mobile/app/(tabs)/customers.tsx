    ...
    <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
      ...
      >
        ...
        >
          ...
          <Text style={[dt.th, { color: colors.mutedForeground, flex: 1.5 }]}>
            Mobile
          </Text>
          <Text
            style={[
              dt.th,
              { color: colors.mutedForeground, flex: 1.5, textAlign: "right" },
            ]}
          >
            Credit Limit
          </Text>
          ...
          <Text
            style={[
              dt.th,
              { color: colors.mutedForeground, flex: 0.8, textAlign: "center" },
            ]}
          >
            Action
          </Text>
          ...
          return (
            ...
            >
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  <Text
                    style={[dt.cellMain, { color: colors.foreground }]}
                    numberOfLines={1}
                  >
                    {c.name}
                  </Text>
                  <Text
                    style={[dt.cellSub, { color: colors.mutedForeground }]}
                    numberOfLines={1}
                  >
                    {c.ownerName}
                  </Text>
              ...
              <Text
                style={[dt.cell, { flex: 1.5, color: colors.mutedForeground }]}
                numberOfLines={1}
              >
                {c.mobile}
              </Text>
              <Text
                style={[
                  dt.cell,
                  { flex: 1.5, textAlign: "right", color: colors.foreground },
                ]}
                numberOfLines={1}
              >
                {fmt(c.creditLimit ?? 0)}
              ...
              <Text
                style={[
                  dt.cell,
                  {
                    ...
                    textAlign: "right",
                    color:
                      c.totalOutstanding > 0 ? colors.overdue : colors.paid,
...
export default function CustomersScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View>
          ...
          {customers && customers.length > 0 && (
            <Text style={[styles.subtitle, { color: colors.mutedForeground }]}>
              {customers.length} stores · Total outstanding:{" "}
      ...
      <View
        style={[styles.searchWrap, { paddingHorizontal: isDesktop ? 28 : 16 }]}
      >
        <SearchBar
          value={search}
      ...
      {isLoading ? (
        ...
        <View style={styles.loader}>
          ...
          <Text style={[styles.loadText, { color: colors.mutedForeground }]}>
            Data safe hai. Thoda wait karke retry karein.
          </Text>
          <TouchableOpacity
          ...
          <EmptyState
            ...
            subtitle={
              search
                ...
                : "Click 'Add Store' to add your first medical store"
            }
          />
        )
      ) : (
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              subtitle={
                search
                  ? "Try a different search"
                  : "Tap + to add your first medical store"
              }
            />
          }
