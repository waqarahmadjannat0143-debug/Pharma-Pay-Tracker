  ...
  return (
    ...
    >
      <View style={styles.row}>
        <View
          style={[styles.iconWrap, { backgroundColor: colors.info + "18" }]}
        >
          <Feather name={icon} size={20} color={colors.info} />
        </View>
        <View style={styles.info}>
          ...
          <Text style={[styles.date, { color: colors.mutedForeground }]}>
            {formatDateDDMMYY(payment.paymentDate)}
          </Text>
        </View>
        <View style={styles.rightCol}>
          <Text style={[styles.amount, { color: colors.paid }]}>
          ...
          <View style={styles.btnRow}>
            ...
            {onWhatsApp && (
              <TouchableOpacity
                style={[
                  styles.actionBtn,
                  { borderColor: "#25D36660", backgroundColor: "#25D36612" },
                ]}
                onPress={onWhatsApp}
                hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}
              >
