...
export function InvoiceCard({
  ...
  const paidPct =
    invoice.billAmount > 0 ? (paidAmount / invoice.billAmount) * 100 : 0;
          ...
          <View style={styles.progressWrap}>
            ...
            >
              <View
                style={[
                  styles.progressFill,
                  { width: `${paidPct}%`, backgroundColor: colors.paid },
                ]}
              />
            </View>
            <Text
        ...
        <View style={styles.footer}>
          <View style={styles.dateChip}>
            ...
            <Text style={[styles.dateText, { color: colors.mutedForeground }]}>
              {formatDateDDMMYY(invoice.invoiceDate)}
            </Text>
          </View>
          <View style={styles.dateChip}>
            <Feather
              name="clock"
              size={10}
              color={isOverdue ? colors.overdue : colors.mutedForeground}
            />
            <Text
              style={[
                styles.dateText,
            ...
            >
              Due {formatDateDDMMYY(invoice.dueDate)}
            </Text>
          </View>
        </View>
      </View>
